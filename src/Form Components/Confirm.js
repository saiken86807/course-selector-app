...
export class Confirm extends Component{
    ...
    render() {
        const {
            values: {courses, altcourses}
                    }= this.props;

        // const ListValues = values.map((value)=><li>{value}</li>)
        return (
            <MuiThemeProvider>
				<>
          <Dialog
          ...
          >
            ...
            <div>
            <ul>{`Course Selected: ${this.courses}`}</ul>
            </div>
				{/* <List>
                    <ListItem>
                        <ListItemText primary="First choice courses" secondary={console.log(this.courses)}/>
                    </ListItem>
                    <ListItem>
                    <ListItemText primary="Second choice courses" secondary={this.altcourses}/>
                    </ListItem> */}
					{/* <ListItem>
                        <ListItemText primary="Course 1: " secondary={this.courses} />
                    </ListItem>  */}
                    {/* <ListItem>
                        <ListItemText primary="Course 2: " secondary={course2} />
                    </ListItem>
